...
export default function TagManager() {
  const { tags, selectedTags, setSelectedTags, createTag, deleteTag, fetchConversations } = useConversationStore();
    ...
    {tags.map((tag) => (
      ...
      >
        ...
        <button
          ...
          className="p-0.5 text-gray-400 hover:text-red-500 rounded-lg"
        >
